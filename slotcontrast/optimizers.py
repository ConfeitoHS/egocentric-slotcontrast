...
class OptimizerBuilder:
    def __init__(
        ...
        **kwargs,
        ...
        self.name = name.lower()   #"adam"
        self.lr = lr    #
        self.param_groups = param_groups # None
    ...
    def __call__(self, modules: Dict[str, nn.Module]):
        ...
        if self.schedule_fn is not None: #True
